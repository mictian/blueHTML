...
module.exports = {
	...
	parseAttributes: function (code_generation_context)
	{
		...
		{
			result = '(function (){var '+code_generation_context.objectName+' = {}; ';
			result += this.concatenateAttributeNodes(attributes_ast, code_generation_context);
			result += 'return {attributes: '+code_generation_context.objectName+'};})()';
		}
		else
		{
			result = '{}';
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	keyValue: function (code_generation_context)
	{
		...
		var key_property_definition = code_generation_context.objectName + '["'+code_generation_context.keyName+'"]="";'
	...
	singleValue: function (code_generation_context)
	{
		...
		{
			return code_generation_context.objectName + '["'+code_generation_context.keyName+'"]+="' + code_generation_context.astNode.value +'";';
		}
		else
		{
			//Single properties like checked or disable are parsed as singleValue
			return code_generation_context.objectName + '["'+code_generation_context.astNode.value+'"]="";';
		}
	},
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	handlebarsATTRSINGLEEVALUATION: function (code_generation_context)
	{
		...
		if (code_generation_context.isSettingValue)
		{
			return code_generation_context.objectName + '["'+code_generation_context.keyName+'"]+=_.escape(' + code_generation_context.currentContextName.value + '.' + code_generation_context.astNode.value +');';
		}
		else
		{
			return code_generation_context.objectName + '[""+_.escape(' + code_generation_context.currentContextName.value + '.' +code_generation_context.astNode.value+')]="";';
		}
	},
	...
	handlebarsATTRLOOKUPSINGLE: function (code_generation_context)
	{
		...
		if (code_generation_context.isSettingValue)
		{
			return code_generation_context.objectName + '["'+code_generation_context.keyName+'"]+=_.escape(' + this._getLookUpContextName(code_generation_context, code_generation_context.astNode) +');';
		}
		else
		{
			return code_generation_context.objectName + '["'+this._getLookUpContextName(code_generation_context, code_generation_context.astNode)+'"]="";';
		}
	},
	...
	handlebarsATTRUNSAFESINGLEEVALUATION: function (code_generation_context)
	{
		...
		if (code_generation_context.isSettingValue)
		{
			return code_generation_context.objectName + '["'+code_generation_context.keyName+'"]+= ' + code_generation_context.currentContextName.value + '.' + code_generation_context.astNode.value +';';
		}
		else
		{
			return code_generation_context.objectName + '[""+'+code_generation_context.currentContextName.value + '.' +code_generation_context.astNode.value+']="";';
		}
	},
	...
	handlebarsATTRREFERENCEEVALUATION: function (code_generation_context)
	{
		...
		{
			var referenced_property = code_generation_context.currentContextName.contextName + '.' + property_name;

			if (code_generation_context.isSettingValue)
			{
				return code_generation_context.objectName + '["'+code_generation_context.keyName+'"]+= _.escape(' + referenced_property +');';
			}
			else
			{
				return code_generation_context.objectName + '[""'+referenced_property+']="";';
			}
		}
